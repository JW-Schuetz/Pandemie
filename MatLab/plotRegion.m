function legendStr = plotRegion( region, datum, data, meanData, color, lineWidth, legendStr, ...
                                 stichTag, mec, mfc )
	...
	if( ~isempty( stichTag ) && ~isempty( data ) )
        ...
        if( ~isempty( data ) )
            ...
            plot( datum, data, 'MarkerEdgeColor', mec, 'Linewidth', 0.5, 'Marker', 'o', ...
                  'MarkerSize', 5, 'MarkerFaceColor', mfc, 'LineStyle', 'none' )
        end
	end
end