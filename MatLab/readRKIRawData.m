...
% debug:        Debugging (nur im Fall idpos=0)
    ...
    switch idpos
        case 0
                ...
                dateFormat = { 'Meldedatum', 'Referenzdatum' };
    ...
    opts = delimitedTextImportOptions( 'Delimiter', ',', 'VariableNamesLine', 1, ...
            'DataLines', [ 2, inf ], 'Encoding', 'UTF-8', 'VariableNames', names, ...
            'VariableTypes', types, 'SelectedVariableNames', selected );
    opts = setvaropts( opts, dateFormat, 'InputFormat', inputFormat );
    opts = setvaropts( opts, dateFormat, 'DatetimeFormat', 'dd.MM.yyyy' );
    opts = setvaropts( opts, { 'Altersgruppe', 'Geschlecht', 'Altersgruppe2' }, ...
                'Ordinal', true );
